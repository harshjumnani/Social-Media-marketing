...
$menuList = ["General" => "general", "Crons" => "crons", "Providers" => "providers", "Payments Methods" => "payment-methods", "Modules" => "modules", "Integrations" => "integrations", "Alert" => "alert", "Bonus" => "payment-bonuses", ];
