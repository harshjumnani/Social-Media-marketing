...
' . $description . '
    ...
    //  $serviceDetails .= '<div class="form-group fields" id="description">
    //           <label for="service_avg_time" class="control-label">Average Time</label>
    //             <div style="display:inline-block;" class="tooltip-wrapper" data-toggle="tooltip" data-placement="right" title="Average time is the time calculated for last 10 orders of this service to get completed" data-original-title="">
    //                     <i class="fas fa-info-circle"></i>

    //                   </div>
    //           <div class="panel-body border-solid border-rounded" id="service_avg_time">
...
<input name="name" value="1"  type="checkbox" ' . $check . ' id="dripfeedcheckbox">
