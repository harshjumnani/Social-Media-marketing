...
<li class='<?php if( route(1) == 'clients' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/clients') ?>'>CLINTS</a></li>
<?php endif; ?>  
...
<li class='<?php if( route(1) == 'subscriptions' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/subscriptions') ?>'>AUTO ORDERS</a></li>
<?php endif; endif; ?>
...
<li class='<?php if( route(1) == 'child-panels' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/child-panels') ?>'>CHILD 
...
echo "<li><a href='#' data-toggle='modal' data-target='#managerModal'><img src='https://ownsmmpanel.in/ownsmmpanel/images/favicon.png' width='20' height='20'></a></li>";
else:
echo "<li><a href='#' data-toggle='modal' data-target='#managerModal'><img src='https://ownsmmpanel.in/ownsmmpanel/images/favicon.png' width='20' height='20'></a></li>";
endif;
...
<li class='<?php if( route(1) == 'account' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/account') ?>'>ACCOUNT</a></li>      
