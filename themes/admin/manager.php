...
<html lang="en" <?php if($user['admin_theme'] == 2){ echo 'class="dark"'; } ?>>
    ...
    <head>
        <meta charset="utf-8">
        <link href="https://ownsmmpanel.in/ownsmmpanel/images/favicon.png" rel="shortcut icon">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>OSP Manager</title>
    ...
    <body>
        <div class="w-full min-h-screen p-5 md:p-20 flex items-center justify-center">
            <div class="intro-y auth">
                <img class="intro-y mx-auto w-16" alt="OwnSMMPanel" src="https://ownsmmpanel.in/ownsmmpanel/images/logofooter.png" width="200" height="40">
