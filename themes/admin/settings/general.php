          ...
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="file" name="logo" id="preferenceLogo">
                        <p class="help-block">200 x 80px are the recommended sizes</p>
            </div>
            <div class="col-md-2">
   ...
   <div class="form-group">
        ...
        <div class="form-group">
                            ...
                            <select class="form-control" name="site_currency">
                                                                                            <option value="INR" <?php if($settings["site_currency"] == "INR"): echo"selected"; endif; ?>>
                                        Indian (INR)
                                    </option>  
          ...
          <div class="col-md-6 form-group">
            <label for="" class="control-label">inr Exchange Rate</label>
            <input type="text" class="form-control" name="inr" value="<?=$settings["inr_charge"]?>">
          </div>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="site_maintenance"> 
            <option value="1" <?= $settings["site_maintenance"] == 1 ? "selected" : null; ?>>Open</option>
            <option value="2" <?= $settings["site_maintenance"] == 2 ? "selected" : null; ?> >Closed</option>
          </select>
        </div>  
        <hr>
        <div class="form-group">
          ...
          <select class="form-control" name="ticket_system">
            <option value="2" <?= $settings["ticket_system"] == 2 ? "selected" : null; ?> >Open</option>
            <option value="1" <?= $settings["ticket_system"] == 1 ? "selected" : null; ?>>Closed</option>
          </select>
        </div>
...
<option value="99" <?= $settings["max_ticket"] == 99 ? "selected" : null; ?>>Unlimited</option>
    ...
    <?php endif; ?>
          ...
          <select class="form-control" name="registration_page">
            <option value="2" <?= $settings["register_page"] == 2 ? "selected" : null; ?>>Open</option>
            <option value="1" <?= $settings["register_page"] == 1 ? "selected" : null; ?>>Closed</option>
          </select>
        </div>
        <div class="form-group">
          <label class="control-label">Number On Signup <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"></span></label>
          <select class="form-control" name="skype_area">
            <option value="2" <?= $settings["skype_area"] == 2 ? "selected" : null; ?>>Active</option>
            <option value="1" <?= $settings["skype_area"] == 1 ? "selected" : null; ?>>Passive</option>
          </select>
        </div>

        <div class="form-group">
          <label class="control-label">Name On Signup <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"></span></label>
          <select class="form-control" name="name_secret">
            <option value="2" <?= $settings["name_secret"] == 2 ? "selected" : null; ?>>Active</option>
            <option value="1" <?= $settings["name_secret"] == 1 ? "selected" : null; ?>>Passive</option>
          </select>
        </div>
               
        <div class="form-group">
          <label class="control-label">Terms at Registration <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"></span></label>
          <select class="form-control" name="terms_checkbox">
            <option value="2" <?= $settings["terms_checkbox"] == 2 ? "selected" : null; ?>>Active</option>
            <option value="1" <?= $settings["terms_checkbox"] == 1 ? "selected" : null; ?>>Passive</option>
          </select>
        </div>
        <div class="form-group">
          <label class="control-label">Confirmation at New Order <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"></span></label>
          <select class="form-control" name="neworder_terms">
            <option value="2" <?= $settings["neworder_terms"] == 2 ? "selected" : null; ?>>Active</option>
            <option value="1" <?= $settings["neworder_terms"] == 1 ? "selected" : null; ?>>Passive</option>
          </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="resetpass">
              ...
              <option value="1" <?= $settings["resetpass_page"] == 1 ? "selected" : null; ?>>Passive</option>
            </select>
        </div> 
        <hr>
      <div class="row">
        <div class="form-group col-md-6">
            ...
            <select class="form-control" name="service_list">
              <option value="2" <?php if($settings["service_list"] == 2){ echo "selected"; } ?>>Open to all</option>
         ...
         <div class="form-group col-md-6">
            ...
            <select class="form-control" name="auto_refill">
              <option value="2" <?php if($settings["auto_refill"] == 2){ echo "selected"; } ?>>Active</option>
              <option value="1" <?php if($settings["auto_refill"] == 1){ echo "selected"; } ?>>Passive</option>
            </select> </div> 
        <div class="form-group col-md-6">
            ...
            <select class="form-control" name="avarage">
              <option value="2" <?php if($settings["avarage"] == 2){ echo "selected"; } ?>>Active</option>
              <option value="1" <?php if($settings["avarage"] == 1){ echo "selected"; } ?>>Passive</option>
            </select>
        </div> 
...
<div class="form-group col-md-6">
            ...
            <select class="form-control" name="sms_verify">
              <option value="2" <?= $settings["sms_verify"] == 2 ? "selected" : null; ?> >Active</option>
              <option value="1" <?= $settings["sms_verify"] == 1 ? "selected" : null; ?>>Passive</option>
            </select>
        </div> 
        <div class="form-group col-md-6">
            <label class="control-label">Mail Verification <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"></span></label>
            <select class="form-control" name="mail_verify">
              <option value="2" <?php if($settings["mail_verify"] == 2){ echo "selected"; } ?>>Active</option>
              <option value="1" <?php if($settings["mail_verify"] == 1){ echo "selected"; } ?>>Passive</option>
            </select>
        </div> 
    </div>    
        <hr />
